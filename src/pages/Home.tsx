...
function HomePage() {
  ...
  const destinations = [
  {
    ...
    description: 'Trek to the foot of the world\'s highest peak through stunning Sherpa villages...',
  ...
  },
  {
    ...
    description: 'Nepal\'s adventure capital with stunning lakes, mountain views, and...',
    season: 'Oct-Apr',
    price: '$350',
  },
  {
    ...
    description: 'Sacred Hindu temple complex and UNESCO World Heritage Site on the...',
    season: 'Year-round',
    price: '$25',
  },
  {
    ...
    description: 'Birthplace of Lord Buddha and a UNESCO World Heritage Site with monasteries for...',
    season: 'Oct-Mar',
    price: '$40',
  },
  {
    ...
    description: 'Nepal\'s first national park and UNESCO site home to one-horned rhinos, tiger...',
    season: 'Oct-Mar',
    price: '$180',
  },
  {
    ...
    description: 'Ancient Newari city with medieval architecture, pottery square, and...',
    season: 'Year-round',
    price: '$30',
  },
];
  ...
  const tourPackages = [
  {
    ...
    image: 'https://unsplash.com',
    description: 'Explore the ancient cities of the Kathmandu Valley-Kathmandu, Patan and Bhaktapur.....',
  ...
  },
  {
    ...
    image: 'https://unsplash.com',
    description: 'The iconic trek to the base of the world\'s tallest peak through dramatic Himalayan.....',
  ...
  },
  {
    ...
    image: 'https://unsplash.com',
    description: 'Visit Nepal\'s most sacred Hindu and Buddha sites including Pashupatinath, Muktinath......',
  ...
  },
  {
    ...
    image: 'https://unsplash.com',
    description: 'Paragliding, zip-lining, bungee jumping, and white-water rafting in Nepal\'s most...',
          ...
          >
            ...
            <div className="grid grid-cols-2 w-full mb-6">
              <div className="border-r border-gray-100 flex flex-col items-center">
                <span className="text-sm font-bold text-gray-700">{guide.trips}</span>
              ...
              <div className="flex flex-col items-center justify-center">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-sm font-bold text-gray-700">{guide.rating}</span>
                </div>
